...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var args, inputDir, outputDir, _i, _a, file, filePath, output, fileName, outputFilePath, err_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    _i = 0;
                    return [4 /*yield*/, fsPromises.readdir(inputDir)];
                case 1:
                    _a = _b.sent();
                    _b.label = 2;
                case 2:
                ...
                case 4:
                    ...
                    outputFilePath = path.join(outputDir, fileName + '.json');
                    return [4 /*yield*/, fsPromises.writeFile(outputFilePath, JSON.stringify(output, null, 2))];
                case 5:
                    _b.sent();
                    _b.label = 6;
                case 6:
                ...
                case 8:
                    err_1 = _b.sent();
                    console.log(err_1); // eslint-disable-line no-console
                    return [3 /*break*/, 9];
