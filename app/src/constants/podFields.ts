...
export const podValueFields = podFields
  .filter((field) => field.fieldType === DescribeFieldType.Value)
  .map((field) => field.field);

export const podArrayFields = podFields
  .filter((field) => field.fieldType === DescribeFieldType.Array)
  .map((field) => field.field);

export const podObjectFields = podFields
  .filter((field) => field.fieldType === DescribeFieldType.Object)
  .map((field) => field.field);
